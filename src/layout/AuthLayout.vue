<template>
  ...
  <div style="border-top: 1px solid rgba(40, 43, 52, 0.1);;background-color: rgb(250,250,250);height: 200px">
        ...
        <svg width="183" height="36" viewBox="0 0 183 36" fill="none" xmlns="http://www.w3.org/2000/svg">
         ...
         <div style="margin-top:20px;text-align: justify;font-family: Inter;width: 70%;
font-style: normal;
font-weight: normal;
font-size: 12px;
line-height: 20px;
...
font-size: 14px;
line-height: 17px;
color: #000000;margin-bottom: 20px">开发者</div>
            <div>工具</div>
            <div>案例与教学</div>
            <div>开发者文档</div>
            <div>GitHub</div>
    ...
    <div  style="width: 80%;margin-left: 10%;margin-top30px;font-family: Inter;
font-style: normal;
font-weight: 300;
font-size: 12px;
line-height: 20px;
